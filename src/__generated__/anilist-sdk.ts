...
export type UserMediaListOptionsFragment = { scoreFormat: ScoreFormat | null, rowOrder: string | null, useLegacyLists: boolean | null, sharedTheme: any | null, sharedThemeEnabled: boolean | null, animeList: { sectionOrder: Array<string | null> | null, splitCompletedSectionByFormat: boolean | null, customLists: Array<string | null> | null, advancedScoring: Array<string | null> | null, advancedScoringEnabled: boolean | null } | null, mangaList: { sectionOrder: Array<string | null> | null, splitCompletedSectionByFormat: boolean | null, customLists: Array<string | null> | null, advancedScoring: Array<string | null> | null, advancedScoringEnabled: boolean | null } | null };
...
export type GetUserStatisticsQuery = { User: { statistics: { anime: { count: number, meanScore: number, minutesWatched: number } | null, manga: { count: number, meanScore: number, chaptersRead: number } | null } | null } | null };
...
export type GetUserStatisticsByUsernameQuery = { User: { statistics: { anime: { count: number, meanScore: number, minutesWatched: number } | null, manga: { count: number, meanScore: number, chaptersRead: number } | null } | null } | null };
